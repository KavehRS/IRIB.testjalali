    ...
    check: function () {
        ...
        if (ip) {
            ...
            if (user_id != e || !t) {
                t = create_UUID();
                m = create_SID();
                user_id = null != e ? e : t, setCookie("uid", t), session_id = null != e ? m : m,  _setCookie("sid", m), user_agent = navigator.IP, referer = document.location.origin, xReferer = document.location.origin;
