...
//            }
            ...
            return xh.open("POST", "{0}session/".format(url), !0), xh.setRequestHeader("Content-Type", "application/json"), xh.setRequestHeader("Authorization", auth_token), xh.onreadystatechange = function () {
