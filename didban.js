...
//             t = create_UUID();   
            ...
            return _o.open("POST", "http://192.168.200.35:8000/api/event/", !0), _o.setRequestHeader("Content-Type", "application/json"), _o.setRequestHeader("Authorization", auth_token), _o.onreadystatechange = function () {
...
//         setCookie("channel_id", e, 1) 
        ...
        return c.open("POST", "http://192.168.200.35:8000/api/event/", !0), c.setRequestHeader("Content-Type", "application/json"), c.setRequestHeader("Authorization", auth_token), c.onreadystatechange = function () {
