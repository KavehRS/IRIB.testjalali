var active_session, ip, user_id, timeout = 1,url = "http://192.168.200.35:8000/", system_id = "Developer",
...
//             t = create_UUID();   
            ...
            return _o.open("POST", "{0}http://192.168.200.35:8000/api/event/", !0), _o.setRequestHeader("Content-Type", "application/json"), _o.setRequestHeader("Authorization", auth_token), _o.onreadystatechange = function () {
   ...
   activityFactory = {
    log: function (e, t, n, si, i, r) {
          ...
          var myVar = setInterval(function(){ a = getCookie("sid"), setCookie("sid", a, 1); }, 57000);  
...
//         setCookie("channel_id", e, 1) 
        ...
        return c.open("POST", "{0}http://192.168.200.35:8000/api/event/", !0), c.setRequestHeader("Content-Type", "application/json"), c.setRequestHeader("Authorization", auth_token), c.onreadystatechange = function () {
