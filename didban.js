    ...
    check: function () {
        ...
        if (ip) {
            ...
            if (user_id != e || !t) {
                ...
                user_id = null != e ? e : t, setCookie("uid", t, 1), session_id = null != e ? m : m,  setCookie("sid", m, 1), user_agent = navigator.userAgent, referer = document.location.origin, xReferer = document.location.origin;
